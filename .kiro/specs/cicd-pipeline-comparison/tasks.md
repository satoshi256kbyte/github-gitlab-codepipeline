...
- [x] 9.1 AWS SAM設定
  - 各CI/CDツール専用リソース用のパラメータ化されたSAMテンプレート（template-codepipeline.yaml）を作成する
...
- [x] 12.2 ドキュメントの作成
  ...
  - LocalStack、act、gitlab-ci-localを使用したローカルテスト環境の詳細な構築手順を文書化する
  - 環境名による条件分岐とローカル環境でのスキップ機能の説明を追加する
